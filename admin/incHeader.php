	...
	<div class="container theme-cosmo theme-compact">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="pageHome.php"><span class="text-info" style="color:orange; font-weight:800;"><i class="glyphicon glyphicon-cog"></i> &nbsp;&nbsp;<?php echo $Translation['admin area']; ?></span></a>
			</div>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<div class="navbar-right" style="margin-top:5px;">
					<a href="<?php echo PREPEND_PATH; ?>index.php" class="btn btn-success navbar-btn" style="border-radius:5px;"><?php echo $Translation["user's area"] ; ?></a>
					<a href="<?php echo PREPEND_PATH; ?>index.php?signOut=1" class="btn btn-warning navbar-btn" style="border-radius:5px;"><i class="glyphicon glyphicon-log-out"></i> <?php echo $Translation["sign out"] ; ?></a>
				</div>
			</div>
		</nav>
		<script>
