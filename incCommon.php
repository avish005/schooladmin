<?php
	...
	*/
	...
	function htmlUserBar(){
		...
		?>
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation"style="border-bottom:1.5px solid blue;">
			...
			<div class="collapse navbar-collapse">
				...
				<?php if(!$_GET['signIn'] && !$_GET['loginFailed']){ ?>
					<?php if(getLoggedMemberID() == $adminConfig['anonymousMember']){ ?>
						...
						<a href="<?php echo PREPEND_PATH; ?>index.php?signIn=1" class="btn btn-primary navbar-btn navbar-right" style="border-radius:5px; margin-top:10px;width:90px;"><?php echo $Translation['sign in']; ?></a>
